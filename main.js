//base by ZIDDIMODS (Xeon Bot Inc.)
//YouTube: @ZIDDIMODS
//Instagram: unicorn_xeon13
//Telegram: t.me/xeonbotinc
//GitHub: @ZIDDIMODS
//WhatsApp: +923168316223
//want more free bot scripts? subscribe to my youtube channel: https://www.youtube.com/@ZIDDIMODS
   ...
   if (pairingCode && !XeonBotInc.authState.creds.registered) {
      ...
      if (!!phoneNumber) {
         ...
         if (!Object.keys(PHONENUMBER_MCC).some(v => phoneNumber.startsWith(v))) {
            console.log(chalk.bgBlack(chalk.redBright("Start with country code of your WhatsApp Number, Example : +923168316223")))
            process.exit(0)
         }
      } else {
         phoneNumber = await question(chalk.bgBlack(chalk.greenBright(`👉PON TU VERGA DE NÚMERO\nEjemplo: +923168316223 : `)))
         phoneNumber = phoneNumber.replace(/[^0-9]/g, '')
...
XeonBotInc.ev.on("connection.update",async  (s) => {
        ...
        if (connection == "open") {
            ...
            console.log(chalk.yellow(`☠️EL BOT ESTÁ CONECTADO☠️` + JSON.stringify(XeonBotInc.user, null, 2)))
			await delay(1999)
...
Naaaa no te creas we es mentira 😂
`))
